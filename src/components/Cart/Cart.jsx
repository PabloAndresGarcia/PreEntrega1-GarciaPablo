...
const Cart = () => {
  ...
  return (
    <div className='wrapper grid'>
        ...
        <h3 className='flex text-xl m-5 font-bold text-primary items-center justify-center' >Total: ${total}</h3>
        <button className='flex m-5 p-1 rounded-xl text-xl font-bold text-secondary-900 bg-primary hover:text-primary hover:bg-secondary-100 items-center justify-center' onClick={() => clearCart()} >Limpiar carrito</button>
